-- Database: "Estimation"
-- Create the Legacy Estimation database for preloading tables

CREATE TABLE defaults (
    co_id integer NOT NULL,
    store character varying(255) DEFAULT ''::character NOT NULL,
    co_name character varying(255) DEFAULT ''::character NOT NULL,
    co_value numeric(19,4) NOT NULL
);

INSERT INTO defaults (co_id, store, co_name, co_value) VALUES
...
ALTER TABLE ONLY defaults
    ADD CONSTRAINT defaults_pk_defaults PRIMARY KEY (co_id);
...
CREATE TABLE ComponentTypes (
   comp_type_id integer NOT NULL,
   comp_type_desc character varying(255) DEFAULT ''::character varying NOT NULL,
   comp_type_sort_order integer DEFAULT 0 NOT NULL,
   comp_type_has_costs boolean DEFAULT true NOT NULL,
   comp_type_has_hours boolean DEFAULT false NOT NULL,
   comp_type_has_vendor boolean DEFAULT false NOT NULL,
   comp_type_has_misc boolean DEFAULT false NOT NULL,
   comp_type_no_entry boolean DEFAULT false NOT NULL,
...
INSERT INTO ComponentTypes (comp_type_id, comp_type_desc, comp_type_sort_order, comp_type_has_costs, comp_type_has_hours, comp_type_has_vendor, comp_type_has_misc, comp_type_no_entry) VALUES
...
ALTER TABLE ComponentTypes
   ALTER COLUMN comp_type_id SET DEFAULT NEXTVAL('component_types_seq'),
   ADD CONSTRAINT component_types_ix_component_types_description UNIQUE(comp_type_desc),
  ADD CONSTRAINT component_types_pk_component_types PRIMARY KEY(comp_type_id),
   ADD CONSTRAINT components_ix_components UNIQUE(comp_type_id, comp_type_desc);
...
CREATE TABLE components (
    ...
    comp_type_id integer NOT NULL,
    comp_desc character varying(255) DEFAULT ''::character varying NOT NULL,
    comp_lu_def_id integer,
    apply_pct_mask integer DEFAULT 0 NOT NULL,
    comp_calc_only boolean DEFAULT false NOT NULL,
...
INSERT INTO components (comp_id, comp_type_id, comp_desc, comp_lu_def_id, apply_pct_mask, comp_calc_only, sort_priority, comp_deleted) VALUES
...
ALTER TABLE ONLY components
    ALTER COLUMN comp_id SET DEFAULT NEXTVAL('components_seq'),
    ADD CONSTRAINT components_pk_components PRIMARY KEY (comp_id),
    ADD CONSTRAINT components_ix_components_type_description UNIQUE(comp_type_id, comp_desc),
    ADD CONSTRAINT components_fk_defaults FOREIGN KEY (comp_lu_def_id) REFERENCES defaults(co_id),
    ADD CONSTRAINT components_fk_component_types FOREIGN KEY (comp_type_id) REFERENCES ComponentTypes(comp_type_id);
...
CREATE TABLE Systems (
    ...
    sys_desc character varying(255) DEFAULT ''::character varying NOT NULL,
    sys_sort_order integer DEFAULT 0 NOT NULL,
    sys_required boolean DEFAULT false NOT NULL,
    sys_deleted boolean DEFAULT false NOT NULL
);
-- ALTER TABLE public.assemblies OWNER TO RoR;


INSERT INTO Systems (sys_id, sys_sort_order, sys_desc, sys_required, sys_deleted) VALUES
(1, 90, 'Rooftop', false, false),
(2, 100, 'Split Systems', false, false),
(3, 110, 'VAV System', false, false),
(4, 60, 'Exhaust Fans/Ventilation', false, false),
(5, 30, 'Controls', false, false),
(6, 70, 'Furnace/Duct Furnace Unit Heater', false, false),
(7, 0, 'Make-up Air', false, false),
(8, 50, 'Ductless Split System', false, false),
(9, 20, 'Chiller', false, false),
(10, 40, 'Cooling Tower', false, false),
(11, 10, 'Boiler', false, false),
(12, 9999, 'Estimate Total', true, false),
(13, 9998, 'Simplified', false, false);

-- DROP SEQUENCE assemblies_seq;
CREATE SEQUENCE systems_seq;
ALTER TABLE ONLY Systems
    ALTER COLUMN sys_id SET DEFAULT NEXTVAL('systems_seq'),
    ADD CONSTRAINT assemblies_pk_assemblies PRIMARY KEY (sys_id),
    ADD CONSTRAINT assemblies_ix_description UNIQUE(sys_desc);
...
CREATE TABLE SystemComponents (
    ...
    sys_comp_desc character varying(255) NULL,
    sys_comp_req boolean DEFAULT true NOT NULL,
    sys_comp_deleted boolean DEFAULT false NOT NULL
);


--ALTER TABLE public.assembly_components OWNER TO postgres;

INSERT INTO SystemComponents (sys_comp_id, sys_comp_comp_id, sys_comp_sys_id, sys_comp_desc, sys_comp_req, sys_comp_deleted) VALUES
...
CREATE SEQUENCE system_components_seq;
ALTER TABLE ONLY SystemComponents
    ALTER COLUMN sys_comp_id SET DEFAULT NEXTVAL('system_components_seq'),
    ADD CONSTRAINT assembly_components_pk_assembly_components PRIMARY KEY (sys_comp_id),
    ADD CONSTRAINT fk_assembly_components_components FOREIGN KEY (sys_comp_comp_id) REFERENCES components(comp_id),
    ADD CONSTRAINT fk_assembly_components_assemblies FOREIGN KEY (sys_comp_sys_id) REFERENCES systems(sys_id);
...
CREATE TABLE TaxTypes (
    ...
    tax_type_desc character varying(255) DEFAULT ''::character varying NOT NULL,
    tax_type_sort_order integer DEFAULT 0 NOT NULL
);


INSERT INTO TaxTypes (tax_type_id, tax_type_desc, tax_type_sort_order) VALUES
(1, 'Tax Exempt Work', 10),
(2, 'New Construction Work', 20),
(3, 'Renovation Work', 30),
(4, 'Residential Work', 40),
(5, 'Manufacturing Work', 50);


CREATE SEQUENCE tax_types_seq;
ALTER TABLE TaxTypes
    ALTER COLUMN tax_type_id SET DEFAULT NEXTVAL('tax_types_seq'),
    ADD CONSTRAINT job_types_pk_id PRIMARY KEY (tax_type_id),
    ADD CONSTRAINT job_types_ix_name UNIQUE(tax_type_desc);
