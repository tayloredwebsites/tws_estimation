...
describe "users/new.html.erb" do
  ...
  context 'renders a mock user' do
    ...
    it "renders all the input elements of the user form" do
      ...
      rendered.should have_xpath('//input[@id="user_roles"][@name="user[roles]"][@value=""]')
      rendered.should have_xpath('//input[@id="user_username"][@name="user[username]"][@value=""]')
      rendered.should have_xpath('//input[@id="user_encrypted_password"][@name="user[encrypted_password]"][@value=""]')
