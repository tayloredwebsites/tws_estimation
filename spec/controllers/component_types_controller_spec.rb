...
describe ComponentTypesController do
  ...
  context 'it should have crud actions available and working' do
    ...
    it 'should be able to GET the index page and see all items' do
      ...
      item2 = ComponentType.create!(FactoryGirl.attributes_for(:component_types))
      item3 = ComponentType.create!(FactoryGirl.attributes_for(:component_types))
      get :index
    ...
    it "should create an item using POST" do
      ...
      new_attributes = FactoryGirl.attributes_for(:component_types)
    ...
    it 'should be able to PUT update an item' do
      item1 = ComponentType.create!(FactoryGirl.attributes_for(:component_types))
      put :update, :id => item1.id, :component_type => FactoryGirl.attributes_for(:component_types).merge({:has_hours => true})
      assigns(:component_type).should_not be_nil
      assigns(:component_type).should be_a(ComponentType)
